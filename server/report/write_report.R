write_report <- function(tempReport, input){
  writeLines(
    c(
      ...
      "  gsea_plot_bp: NULL",
      "  gsea_plot_mf: NULL",
      "  gseaplot_text_bp: NULL",
      "  gseaplot_text_mf: NULL",
      ...
      "cat(paste0('Student ID: ', params$uin))",
      ...
      "# Background",
      "```{r, echo=FALSE}",
      "cat(ifelse(is.null(params$findings) || params$findings == \"\", \"No Background Provided\", params$findings))",
      "```",
      "",
      "# Sample Information",
      "```{r, echo=FALSE}",
      "cat(ifelse(is.null(params$abstract) || params$abstract == \"\", \"No Information Provided\", params$abstract))",
      "```",
      "",
      "# Metadata",
      "```{r, echo=FALSE}",
      ...
      "            title = paste('Top', params$go_term_count, 'BP - Activated Genes')) +",
      "      theme_minimal() +",
      "      theme(",
      ...
      "      )",
      "  } else {",
      "    cat('No BP enrichment found for Activated genes.')",
      "  }",
      "}, error = function(e) {",
      "  cat('Error in BP Activated plot:', e$message)",
      "})",
      "```",
      "",
      "```{r, echo=FALSE, fig.height=10, fig.width=10}",
      ...
      "            title = paste('Top', params$go_term_count, 'BP - Suppressed Genes')) +",
      "      theme_minimal() +",
      "      theme(",
      "        axis.text.x = element_text(size = 18, angle = 45, hjust = 1),",
      "        axis.text.y = element_text(size = 18),",
      ...
      "      )",
      "  } else {",
      "    cat('No BP enrichment found for Suppressed genes.')",
      "  }",
      "}, error = function(e) {",
      "  cat('Error in BP Suppressed plot:', e$message)",
      "})",
      "```",
      ...
      "            title = paste('Top', params$go_term_count, 'MF - Activated Genes')) +",
      "      theme_minimal() +",
      "      theme(",
      "        axis.text.x = element_text(size = 18, angle = 45, hjust = 1),",
      "        axis.text.y = element_text(size = 18),",
      ...
      "      )",
      "  } else {",
      "    cat('No MF enrichment found for Activated genes.')",
      "  }",
      "}, error = function(e) {",
      "  cat('Error in MF Activated plot:', e$message)",
      "})",
      "```",
      "",
      "```{r, echo=FALSE, fig.height=10, fig.width=10}",
      ...
      "            title = paste('Top', params$go_term_count, 'MF - Suppressed Genes')) +",
      "      theme_minimal() +",
      "      theme(",
      "        axis.text.x = element_text(size = 18, angle = 45, hjust = 1),",
      "        axis.text.y = element_text(size = 18),",
      ...
      "      )",
      "  } else {",
      "    cat('No MF enrichment found for Suppressed genes.')",
      "  }",
      "}, error = function(e) {",
      "  cat('Error in MF Suppressed plot:', e$message)",
      "})",
      "```",
      "",
